...
public class ExampleFrame_05 {


    public static void main(String args[])throws Exception {
        ExampleFrame_05 ui = new ExampleFrame_05();
        ui.show();
    }
    ...
    public void show()throws Exception {
         ...
         * 生成窗体中的各种组件
         */
        ImageIcon imageQQ = new ImageIcon(ImageIO.read(new File("D:\\IdeaProjects\\swing-utils\\src\\main\\resources\\control_panel_128px_1221575_easyicon.net.png")));
        JLabel component1 = new JLabel(imageQQ);
        //组件1 是界面上的QQ蓝色面板图像，图像我们把它放在JLabel类对象上
        ImageIcon imageqq = new ImageIcon(ImageIO.read(new File("D:\\IdeaProjects\\swing-utils\\src\\main\\resources\\QQ_300px_1230490_easyicon.net.png")));
